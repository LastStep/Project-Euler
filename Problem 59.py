...
coded_ascii_text = [int(i) for i in coded_ascii_text]
key = [chr(Counter(coded_ascii_text[i::3]).most_common(1)[0][0] ^ 32) for i in range(3)]
...
def main():
  ...
  for k,text in enumerate(coded_ascii_text):
    ...
    try:
      ...
      pass
  return decoded_text, decoded_text_sum

if __name__ == '__main__':
  decoded_text, decoded_text_sum = main()
  print(decoded_text)
  print(key)
